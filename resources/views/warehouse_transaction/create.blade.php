...
<body class="bg-gray-100 min-h-screen p-6">
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-6">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-gray-800">اضافة حركة مستودع</h2>
            <a href="{{ route('warehouse_transactions.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition">رجوع</a>
        </div>
        <form action="{{ route('warehouse_transactions.store') }}" method="POST" class="space-y-4">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="driver_name" value="{{ old('driver_name') }}" required class="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary">
                ...
                <div>
                    ...
                    <input type="text" name="car_number" value="{{ old('car_number') }}" required class="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary">
                ...
                <div>
                    ...
                    <input type="text" name="quantity" value="{{ old('quantity') }}" required class="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary">
                    @error('quantity') <p class="text-red-500 text-sm mt-1">{{ $message }}</p> @enderror
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">التاريخ</label>
                    <input type="date" name="date" value="{{ old('date', now()->toDateString()) }}" required class="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary">
                ...
                <div>
                    ...
                    <input type="text" name="source" value="{{ old('source') }}" class="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary">
                </div>
            </div>
            <div>
            ...
            <div class="flex justify-end">
                <button type="submit" class="bg-primary-strong text-white px-6 py-2 rounded-lg hover:bg-primary-strong transition">حفظ</button>
            </div>
        </form>
    </div>
