...
@section('title', 'تقرير العدادات بالماكينات بالفترة')
...
@section('content')
    <div class="max-w-6xl mx-auto bg-white p-6 mt-10 rounded-lg shadow-md">
        <h2 class="text-xl font-semibold mb-6 text-gray-700">تقرير العدادات بالماكينات بالفترة</h2>

        <form action="{{ route('reports.machine_report_time.result') }}" method="POST" class="grid grid-cols-1 md:grid-cols-3 gap-6">
            @csrf
