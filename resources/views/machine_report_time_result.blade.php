...
@section('title', 'نتيجة تقرير العدادات بالماكينات بالفترة')
    ...
    <div class="max-w-6xl mx-auto mt-10 bg-white shadow-lg rounded-xl p-6 print-card">
        ...
        <div class="flex items-center justify-between border-b pb-4 mb-6">
            <div class="flex items-center gap-4">
                ...
                <h2 class="text-2xl font-bold text-gray-700">تقرير العدادات بالماكينات بالفترة</h2>
            </div>
            <div class="no-print flex gap-3">
                <a href="{{ route('reports.machine_report_time') }}"
