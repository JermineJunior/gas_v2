...
@section('title', 'تقرير اضافات المستودعات')
...
@section('content')
    <div class="max-w-6xl mx-auto bg-white p-6 mt-10 rounded-lg shadow-md">
        <h2 class="text-xl font-semibold mb-6 text-gray-700">تقرير اضافات المستودعات</h2>

        <form action="{{ route('warehouse_reports.additions.result') }}" method="POST" class="grid grid-cols-1 md:grid-cols-3 gap-6">
            @csrf
            ...
            <div>
                <label class="block text-sm font-medium text-gray-600 mb-1">المصدر</label>
                <input type="text" name="source" placeholder="بحث بالمصدر..."
