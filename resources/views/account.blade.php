            ...
            <div class="p-6">
                ...
                <div class="mb-4">
                    <input type="text" id="searchName" placeholder="ابحث بالاسم..."
                        class="border border-gray-300 rounded-lg px-3 py-2 w-64 focus:ring focus:ring-blue-300">
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full min-w-[900px] table-auto border-collapse">
                        ...
                        <tbody id="accountsBody">
                            ...
                            @endforelse
                            <tr>
                                <td colspan="5" class="text-right font-bold px-4 py-4">الاجمالي</td>
            ...
            <form action="{{ route('client.details.store') }}" method="POST" id="storeForm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input name="total" type="text" readonly id="add_total"
        ...
        <div class="bg-white rounded-xl w-full max-w-lg p-6 shadow-lg">
            ...
            <form id="editForm" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium mb-1">الإجمالي</label>
                        <input id="edit_total" name="total" type="text" readonly
                            class="w-full border bg-gray-100 rounded-lg px-3 py-2" />
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium mb-1">التفاصيل</label>
        ...
        $(document).ready(function() {
            ...
            document.getElementById('searchName').addEventListener('keyup', function() {
                ...
                timer = setTimeout(() => {
                    ...
                    fetch("{{ route('client.details.search', $client->id) }}?name=" +
                ...
                }, 300); // انتظار 300ms لمنع ضغط السيرفر
            });
