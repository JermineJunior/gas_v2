...
@section('content')
    <div x-data="{ openAdd: false, openEdit: false, editUser: { id: '', name: '', username: '', stations: [], role_id: '' } }">
                                ...
                                <td class="px-4 py-3 flex gap-2">
                                    ...
                                    <form action="{{ route('user.reset', $user->id) }}" method="POST">
                                        ...
                                        <button type="button" class="reset-btn text-white px-3 py-1 rounded-lg"
                                            style="background-color: #64748b; transition: background-color 0.2s;"
        ...
        <div x-show="openAdd" x-transition
            ...
            <div class="bg-white rounded-2xl shadow-lg w-full max-w-lg p-6 relative">
                ...
                <h2 class="text-2xl font-bold mb-6 text-gray-800 text-center">اضافة مستخدم جديد</h2>
            ...
            <div class="bg-white rounded-2xl shadow-lg w-full max-w-lg p-6 relative">
                ...
                <form action="{{ route('user.update') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="password" name="password" placeholder="اتركه فارغ اذا لم ترد تغييره"
                            class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                    </div>
                    <div>
                        <label class="block text-gray-700 mb-1">المحطات</label>
        ...
        $(document).ready(function() {
            ...
            document.querySelectorAll('.reset-btn').forEach(button => {
                button.addEventListener('click', function(e) {
                    ...
                    Swal.fire({
                        title: 'هل انت متأكد؟',
                        text: "هل تريد فعلا استعادة كلمة السر ؟",
                        icon: 'info',
                        showCancelButton: true,
                        confirmButtonColor: '#3085d6',
                        cancelButtonColor: '#d33',
