...
CREATE TABLE `deposit_details` (
  ...
  KEY `deposit_details_approved_by_foreign` (`approved_by`),
  CONSTRAINT `deposit_details_approved_by_foreign` FOREIGN KEY (`approved_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `deposits` (
  ...
  `expenses_total` decimal(15,2) NOT NULL DEFAULT 0.00,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `expense_details` (
  ...
  KEY `expense_details_station_id_foreign` (`station_id`),
  KEY `expense_details_approved_by_foreign` (`approved_by`),
  CONSTRAINT `expense_details_approved_by_foreign` FOREIGN KEY (`approved_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `expense_details_expense_id_foreign` FOREIGN KEY (`expense_id`) REFERENCES `expenses` (`id`) ON DELETE CASCADE,
  CONSTRAINT `expense_details_station_id_foreign` FOREIGN KEY (`station_id`) REFERENCES `stations` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `expenses` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `expenses_station_id_foreign` (`station_id`),
  KEY `expenses_user_id_foreign` (`user_id`),
  CONSTRAINT `expenses_station_id_foreign` FOREIGN KEY (`station_id`) REFERENCES `stations` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `machine_details` (
  ...
  `is_rollover` tinyint(1) NOT NULL DEFAULT 0,
  ...
  KEY `machine_details_approved_by_foreign` (`approved_by`),
  CONSTRAINT `machine_details_approved_by_foreign` FOREIGN KEY (`approved_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `machines` (
  ...
  `max_counter` bigint(20) unsigned NOT NULL DEFAULT 9999999,
  `allowed_rollover` decimal(15,2) DEFAULT NULL,
  `use_rollover` tinyint(1) NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`),
...
CREATE TABLE `stations` (
  ...
  `default_max_counter` decimal(15,2) DEFAULT NULL,
  `default_allowed_rollover` decimal(15,2) DEFAULT NULL,
  `default_use_rollover` tinyint(1) NOT NULL DEFAULT 1,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `stock_detail_photos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `stock_detail_photos` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `stock_detail_id` bigint(20) unsigned NOT NULL,
  `path` varchar(255) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `stock_detail_photos_stock_detail_id_foreign` (`stock_detail_id`),
  CONSTRAINT `stock_detail_photos_stock_detail_id_foreign` FOREIGN KEY (`stock_detail_id`) REFERENCES `stock_details` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stocks` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `stocks_name_station_id_unique` (`name`,`station_id`),
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (32,'2026_08_22_152829_add_max_counter_to_machines_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (33,'2026_08_22_152830_add_is_rollover_to_machine_details_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (34,'2026_08_22_170238_add_approval_fields_to_deposit_details_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (35,'2026_08_22_213327_create_expenses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (36,'2026_08_22_213328_create_expense_details_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (37,'2026_08_23_092153_add_meter_settings_to_stations_and_machines',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (38,'2026_08_23_095227_add_meter_approval_settings_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (39,'2026_08_24_075033_scope_stocks_name_unique_per_station',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (40,'2026_08_25_000001_add_expenses_total_to_deposits_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (41,'2026_08_29_092200_stock_detail_photos',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (42,'2026_08_29_100000_add_details_to_employees_table',3);
COMMIT;
