...
Yonville que la petite Bovary, depuis un an, était expense chez
...
Puis, expense à la Croix rouge, elle se jeta sur son lit, dans la
...
EOT;
    ...
    *** START: FULL LICENSE ***
    ...
    expense Service.  The Foundation's EIN or federal tax identification
